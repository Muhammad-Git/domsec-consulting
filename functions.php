...
function theme_scripts() {
  ...
  //stryling kay lye//
    ...
    /*wp_enqueue_style( 'layout', get_template_directory_uri() . '/assets/css/lib.css' );
    ...
    /*wp_enqueue_script( 'main-lib', get_template_directory_uri() . '/assets/js/lib.js', array(), '1.0.0', true );
    wp_enqueue_script( 'wow-animate', get_template_directory_uri() . '/assets/js/wow-animate.js', array(), '1.0.0', true );*/
